...
export DB_HOST=$(php envoy get_env DATABASE_HOST)
export DB_PASS=$(php envoy get_env DATABASE_PASSWORD)
export DB_USER=$(php envoy get_env DATABASE_USER)
export DB_NAME=$(php envoy get_env DATABASE_NAME)

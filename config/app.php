...
return [
    ...
    */
    'hooks' => [
        ...
        App\Hooks\Articles::class,
        App\Hooks\Assets::class,
        App\Hooks\Compat::class,
        App\Hooks\Emojis::class,
        App\Hooks\Front::class,
        App\Hooks\Install::class,
        App\Hooks\Mail::class,
        App\Hooks\Menu::class,
        App\Hooks\Pages::class,
        App\Hooks\Projects::class,
        App\Hooks\Services::class,
